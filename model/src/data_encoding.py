...
# 'MG', 'ZN', 'CL', 'CA', 'NA', 'MN', 'K', 'IOD', 'CD', 'CU', 'FE', 'NI',
#             'SR', 'BR', 'CO',
# resname categories
categ_to_resnames = {
    ...
    "ligand": ['SO4', 'NAG', 'PO4', 'EDO', 'ACT', 'MAN', 'HEM', 'FMT', 'BMA',
               ...
               'AMP', 'NDP', 'SAH', 'OXY', 'MGR', 'B12', 'ROS', '5BU', 'NME', 
               'BDR', 'NEB', 'BDG', 'IDG', 'G0B', '2TB', 'TOC', 'TOA', 'LHA', 
               'IU', '747', 'U37', 'GTP', '4BW', '2BA', '8OS', 'GE1', 'TEP', 
               'GAI', 'CSL', '0EC', 'CS', 'GND', 'CBV', 'SRY', 'L8H', 'BDG', 
               'NH4', 'UMS', 'I2A', 'GE2', 'PAR', 'TOB', 'AM2', '6F7', 'A23', 
               'NCO', 'GE3', 'DAI', 'RIB', 'AMZ', 'CCC', '2QC', 'IRI', 'P12', 'PA1', 'ADE', 'TPP', 'D2X', 'SFG', 'PRF',
               'P14', 'IR3', 'NMY', 'CYY', 'ISH', 'PMZ', 'AG2', 'PSU', 'GNG', 
               'P13', 'C2E', 'SAM', 'SS0', 'SIS', 'MG', 'ZN', 'CL', 'CA', 'NA', 'MN', 'K', 'IOD', 'CD', 'CU', 'FE', 'NI',
            'SR', 'BR', 'CO'],
...
def extract_all_contacts(subunits, r_thr, device=pt.device("cpu")):
    ...
    for i in range(len(snames)):
        ...
        for j in range(i+1, len(snames)):
            ...
            if snames[j].count(':') == snames[i].count(':'):
                continue
